...
SECRET_KEY = 'django-insecure-=3rbo!p5@7m2m=74hg5k&^a^eqb5$_#qundx4*s=hs(5%9^on9'
...
if 'test' in sys.argv:
    DATABASES['default'] = {
        ...
        'NAME': 'test_myapp',  # The name of the test database (it will be created automatically)
        'USER': 'your_db_user',
